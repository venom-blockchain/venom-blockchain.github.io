...
Perhaps, you already can setup your venom developer environment. If not - follow [this](../setting-up-a-venom-smart-contract-development-environment.md) guide. If you already familiar with this action - let's start with locklift init.
